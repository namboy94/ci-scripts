...
from gitlab_build_scripts.metadata import version_number

# -*- coding: utf-8 -*-
#
# gitlab-build-scripts documentation build configuration file, created by
...
#
# html_title = 'gitlab-build-scripts v0.0.1'
